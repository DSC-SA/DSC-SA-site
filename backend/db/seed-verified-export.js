...
const seedVerifiedData = async () => {
  try {
    ...
    const heroes = [
      ...
      { name: 'Amon', role: 'Assassin', description: 'Shadow assassin', attack: 10, defense: 5, hp: 6 },
      ...
      { name: 'Astaroth', role: 'Tank', description: 'Shadow tank', attack: 6, defense: 10, hp: 10 },
      ...
      { name: 'Sahr', role: 'Mage', description: 'Shadow mage', attack: 8, defense: 5, hp: 7 },
      ...
      { name: 'Shar', role: 'Mage', description: 'Shadow mage', attack: 8, defense: 5, hp: 7 },
