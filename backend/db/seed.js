...
const seedData = async () => {
  try {
    ...
    // Seed MLBB Heroes - All 148 Heroes
    const heroes = [
      ...
      { name: 'Attrition', role: 'Marksman', description: 'Range marksman', attack: 10, defense: 4, hp: 5 },
      ...
      { name: 'Braxtons', role: 'Tank', description: 'Tank hero', attack: 6, defense: 9, hp: 10 },
      { name: 'Britney', role: 'Support', description: 'CC support', attack: 5, defense: 6, hp: 7 },
      { name: 'Bruno', role: 'Marksman', description: 'Mobile marksman', attack: 10, defense: 5, hp: 6 },
      { name: 'Camilot', role: 'Tank', description: 'Control tank', attack: 6, defense: 9, hp: 10 },
      { name: 'Change', role: 'Mage', description: 'Burst sustain', attack: 8, defense: 5, hp: 7 },
      ...
      { name: 'Daigso', role: 'Fighter', description: 'Sustain CC', attack: 9, defense: 7, hp: 8 },
      { name: 'Dangross', role: 'Fighter', description: 'Durable sustain', attack: 9, defense: 7, hp: 9 },
      ...
      { name: 'Ding', role: 'Tank', description: 'Control durability', attack: 6, defense: 9, hp: 10 },
      ...
      { name: 'Hanab', role: 'Marksman', description: 'Burst control', attack: 10, defense: 5, hp: 6 },
      ...
      { name: 'Khem', role: 'Tank', description: 'Durable control', attack: 6, defense: 10, hp: 10 },
      ...
      { name: 'Rexie', role: 'Tank', description: 'Durable control', attack: 6, defense: 10, hp: 10 },
      { name: 'Rie', role: 'Mage', description: 'Control sustain', attack: 8, defense: 5, hp: 7 },
      ...
      { name: 'Spindle', role: 'Tank', description: 'Control durability', attack: 6, defense: 9, hp: 10 },
      { name: 'Starlight', role: 'Support', description: 'Healing utility', attack: 5, defense: 6, hp: 7 },
      { name: 'Terizla', role: 'Tank', description: 'Durable control', attack: 6, defense: 10, hp: 10 },
      { name: 'Thamsteen', role: 'Tank', description: 'Durable control', attack: 6, defense: 10, hp: 10 },
      ...
      { name: 'Astaroth', role: 'Tank', description: 'Durable control', attack: 6, defense: 10, hp: 10 },
      { name: 'Beno', role: 'Fighter', description: 'Mobile sustain', attack: 9, defense: 8, hp: 8 },
      ...
      { name: 'Floryn', role: 'Support', description: 'Healing utility', attack: 5, defense: 6, hp: 7 },
      ...
      { name: 'Aatrox', role: 'Support', description: 'Healing CC', attack: 5, defense: 7, hp: 7 },
      { name: 'Yorn', role: 'Assassin', description: 'Mobile burst', attack: 10, defense: 5, hp: 6 },
      { name: 'Moskov Prime', role: 'Tank', description: 'Durable control', attack: 6, defense: 10, hp: 10 },
      { name: 'Layla', role: 'Marksman', description: 'Range burst', attack: 10, defense: 5, hp: 6 },
      { name: 'Venom', role: 'Tank', description: 'Durable control', attack: 6, defense: 10, hp: 10 },
      { name: 'Cleric', role: 'Marksman', description: 'Range burst', attack: 10, defense: 4, hp: 5 },
      { name: 'Martian', role: 'Marksman', description: 'Range burst', attack: 10, defense: 4, hp: 5 },
      { name: 'Kagura Prime', role: 'Mage', description: 'Control burst', attack: 8, defense: 5, hp: 7 },
      { name: 'Balmond Prime', role: 'Fighter', description: 'Mobile sustain', attack: 9, defense: 8, hp: 9 }
    ];
    ...
    console.log('✓ Database seeded with heroes and items');
  } catch (err) {
