  ...
  return (
    <Layout>
      <div className="mx-auto max-w-4xl px-4 py-12">
        <h1 className="mb-2 bg-gradient-to-r from-brand-bluedd to-brand-blue bg-clip-text font-display text-5xl font-black text-transparent">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-brand-ink">
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl font-bold text-brand-ink">1. Information We Collect</h2>
            <div className="space-y-4">
              <div>
                <h3 className="mb-2 text-lg font-semibold text-brand-bluedd">Community & Messaging Data</h3>
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold text-brand-bluedd">Contact & Account Information</h3>
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold text-brand-bluedd">Gaming & Account Information</h3>
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold text-brand-bluedd">Bot & Economy Data</h3>
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold text-brand-bluedd">Website & Usage Data</h3>
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl font-bold text-brand-ink">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl font-bold text-brand-ink">3. Data Sharing</h2>
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl font-bold text-brand-ink">4. Data Security</h2>
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl font-bold text-brand-ink">5. Your Rights</h2>
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl font-bold text-brand-ink">6. External Links</h2>
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl font-bold text-brand-ink">7. Bot Registration & Economy Features</h2>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="mb-2 text-lg font-semibold text-brand-bluedd">Data Usage</h3>
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold text-brand-bluedd">Consent</h3>
                <p>Continued use of our bots, systems, or services indicates acceptance of this Privacy Policy and any future updates.</p>
              </div>
              <div>
                <h3 className="mb-2 text-lg font-semibold text-brand-bluedd">Experimental Features Disclaimer</h3>
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold text-brand-bluedd">Data Removal</h3>
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl font-bold text-brand-ink">8. Policy Updates</h2>
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl font-bold text-brand-ink">9. Contact Us</h2>
